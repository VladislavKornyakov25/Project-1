...
console.log(`There is ${_main_js__WEBPACK_IMPORTED_MODULE_0__.one} and ${_main_js__WEBPACK_IMPORTED_MODULE_0__.two}`);
...
// console.log(`There is ${data.one} and ${data.two}`);
// data.sayHello();
})();
